...
<script>
    export default {
        ...
        computed: {
            formattedDate() {
                return this.$moment(`${this.year}-${this.month}-1`, 'YYYY-M-D').format('MMMM YYYY'); //ES6 template literal. A string enclosed by backticks, including ${ } to embed expressions.
            },
            month() {
